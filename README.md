> This file consists of notes to myself while carrying out interactive tests. To be cleaned up and rewritten.

Tools to include: Scramble, MELT, Mobster, DeepMEI
